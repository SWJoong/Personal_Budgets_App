  ...
  return (
    <>
      <button
        ...
        className={
          className ??
          'flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-muted hover:bg-muted-hover hover:text-foreground text-muted-foreground text-sm font-bold transition-colors'
        }
        aria-label="도움말"

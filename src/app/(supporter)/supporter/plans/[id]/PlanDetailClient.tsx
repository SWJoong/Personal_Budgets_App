          ...
          NARRATIVE_FIELDS.map(({ key, label }) => (
            <div key={key} className="flex flex-col gap-1">
              ...
              <textarea
                ...
                rows={2}
                className="p-3 rounded-xl bg-muted ring-1 ring-border text-sm leading-relaxed resize-none"
              />
            </div>
          ))
        ) : narrative ? (
                ...
                <details className="mt-1">
                  ...
                  <div className="flex flex-col gap-2 pt-2">
                    ...
                    <textarea
                      ...
                      rows={2}
                      className="p-2 rounded-lg bg-muted ring-1 ring-border text-sm resize-none"
                    />
                    <Button
                      type="button"
                      variant="primary"
